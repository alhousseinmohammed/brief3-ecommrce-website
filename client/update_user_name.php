    ...
    <div class="container">
        ...
        <div class="account-details-container">
            ...
            <div class="details-item">
                ...
                <form action="change_user_name.php?id=<?php echo $result_user[0]["user_id"]; ?>" method="post">
                    <input type="text" value="<?php echo $result_user[0]["user_name"] ?>" name="user_name">
            ...
            <div class="details-item">
                <a href="update_user_password.php?id=<?php echo $result_user[0]["user_id"]; ?>" class="btn btn-link">Change Password</a>
            </div>
        </div>
